...
async def ban_user(message:Message):
    ...
    await message.answer(f"{message.reply_to_message.from_user.first_name} Siz tartib buzarligingiz uchun guruhdan chiqarilib yuborildingiz.")

@dp.message(and_f(F.reply_to_message,F.text=="/unban"))
async def unban_user(message:Message):
    user_id =  message.reply_to_message.from_user.id
    await message.chat.unban_sender_chat(user_id)
    await message.answer(f"{message.reply_to_message.from_user.first_name} Endi guruhga qaytishingiz mumkin.")
...
async def mute_user(message:Message):
    ...
    await message.answer(f"{message.reply_to_message.from_user.first_name} Siz tartib buzarligingiz uchun 5 minutga blocklandingiz")
...
async def unmute_user(message:Message):
    ...
    await message.answer(f"{message.reply_to_message.from_user.first_name} Endi guruhga yoza olasiz")
...
async def gef_yuborma(message:Message):
            user_id =  message.from_user.id
            await message.chat.ban_sender_chat(user_id)
            await message.answer_photo(f"{message.from_user.mention_html()} E bola kata xato qilding rasm tashlab 1 soatga bliklanding 😔")
            await message.delete()
...
async def gef_yuborma(message:Message):
            user_id =  message.from_user.id
            await message.chat.ban_sender_chat(user_id)
            await message.answer_video(f"{message.from_user.mention_html()} E bola katta xato qilding video tashlab 1 soatga bloklanding 😔")
            await message.delete()
